...
export interface ApiPeakAndPlatePeakAndPlate
  extends Struct.CollectionTypeSchema {
  collectionName: 'peak_and_plates';
  info: {
    singularName: 'peak-and-plate';
    pluralName: 'peak-and-plates';
    displayName: 'Peak and Plate';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiPeakHourPeakHour extends Struct.CollectionTypeSchema {
  collectionName: 'peak_hours';
  info: {
